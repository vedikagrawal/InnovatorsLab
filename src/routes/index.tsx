...
// Subtle blueprint grid + gear pattern used behind light sections (very low opacity).
const BLUEPRINT_BG =
...
function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#16307a] via-[#0f1f54] to-[#0a1024]">
      {/* Decorative floating CAD wireframe — sits behind content, hidden on small screens */}
      <img
        src={heroCad}
        alt=""
        aria-hidden="true"
...
function Process() {
  return (
    <section
      id="process"
      className="relative overflow-hidden bg-gradient-to-b from-[#16307a] via-[#0f1f54] to-[#0a1024] py-20 sm:py-24"
    >
      {/* Decorative engineering blueprint — extremely subtle, behind content */}
      <img
...
function HowItWorks() {
  return (
    <section
      id="how-it-works"
      className="relative overflow-hidden bg-slate-50 py-20 text-slate-900 sm:py-24"
    >
      <BlueprintBackdrop />
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <p className="text-center text-xs font-semibold uppercase tracking-[0.22em] text-sky-600">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8">
            <div className="flex items-start justify-between gap-4">
              ...
              <img
                src={designSketch}
                alt="Industrial design sketch of a product concept"
                loading="lazy"
                className="h-20 w-20 shrink-0 select-none object-contain sm:h-24 sm:w-24"
              />
            </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8">
            <div className="flex items-start justify-between gap-4">
              ...
              <img
                src={copyrightIdea}
                alt="Lightbulb with circuit traces representing protected ideas"
                loading="lazy"
                className="h-20 w-20 shrink-0 select-none object-contain sm:h-24 sm:w-24"
              />
            </div>
